...
class Bill_App:
    def __init__(self,root):
        ...
        lbl_color = 'white'
        #Title of App
        title = Label(self.root,text = "SmartPOS",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
